package com.czsm.Demand_Driver.view;
...
/**
 * Created by Active2 on 30/01/2016.
 */
public class CustomDateTimePicker implements View.OnClickListener {
    ...
    public View getDateTimePickerLayout() {
        ...
        btn_setDate.setText(R.string.set_date);
        btn_setDate.setId(R.id.SET_DATE);
        btn_setDate.setOnClickListener(this);

        btn_setTime = new Button(activity);
        btn_setTime.setLayoutParams(button_params);
        btn_setTime.setText(R.string.set_time);
        btn_setTime.setId(R.id.SET_TIME);
