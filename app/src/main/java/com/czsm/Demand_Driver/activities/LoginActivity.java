...
public class LoginActivity extends AppCompatActivity implements Validator.ValidationListener, RESTClient.ServiceResponseInterface {
    ...
    @BindView(R.id.login_isprovider_checkbox)
    CheckBox isProvider;

    @BindView(R.id.login_signin_button)
    Button signinButton;

    @BindView(R.id.login_new_account_textview)
    TextView newAccount;

    @BindView(R.id.login_provider_signup_button)
...
//        }
        ...
        newAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SIGNUP_TYPE = "user";
                Intent otpIntent = new Intent(getApplicationContext(), UserSignupActivity.class);
