package com.czsm.Demand_Driver.receiver;
            ...
            if (PushdataOpen.get("mode") != null) {
                if (PushdataOpen.get("mode").toString().equals("CANCEL_APPOINTMENT") || PushdataOpen.get("mode").toString().equals("CONFIRM_APPOINTMENT")) {
                    ...
                    if (!RESTClient.ID.equalsIgnoreCase("")) {
                        Intent resultIntent = new Intent(context, com.czsm.Demand_Driver.activities.DashBoardActivity.class);
                        resultIntent.putExtra("FROM_PUSH", "1");
                        resultIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        Pushbots.sharedInstance().startActivity(resultIntent);
                    } else {
                        Intent resultIntent = new Intent(context, com.czsm.Demand_Driver.activities.LoginActivity.class);
                        resultIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        Pushbots.sharedInstance().startActivity(resultIntent);
                    }
